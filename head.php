...
<body>
 <div class="ui container">
  ...
  <a id="index" href="index.php" class="item ">
    Home
  </a>
  <a id="empresa" href="empresa.php" class="item">
    Empresa
  </a>
   <div id="catalogo" class="ui dropdown item">
    Catalogo<i class="dropdown icon"></i>
    <div class="menu">
  ...
  <a id="trabajos" href="trabajos.php" class="item">
   Trabajos
  </a>
  <a id="clientes" href="clientes.php" class="item">
    Clientes
  </a>
  <a id="contactos" href="contactos.php" class="item">
    Contactos
  </a>
